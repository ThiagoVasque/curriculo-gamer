<div id="modalEdicao" class="hidden fixed inset-0 bg-black/95 backdrop-blur-md z-50 flex items-center justify-center p-4">
    <div class="bg-[#1a1d2e] w-full max-w-4xl rounded-3xl border border-gray-700 overflow-hidden shadow-2xl relative flex flex-col md:flex-row max-h-[90vh] overflow-y-auto custom-scrollbar">
        ...
        <div class="w-full md:w-1/3 bg-[#0f111a] p-6 flex flex-col items-center border-r border-gray-800">
            ...
            <p id="modalYear" class="text-gray-500 text-[10px] font-bold mt-1 uppercase"></p>
        </div>
        ...
        <div class="w-full md:w-2/3 p-8 flex flex-col">
            ...
            <div class="mb-6">
                <div class="flex justify-between items-center mb-3">
                    ...
                    <div class="flex gap-2 bg-[#0f111a] p-1 rounded-lg border border-gray-800">
                        <button type="button" onclick="traduzirNoDashboard('en')" id="btn-dash-en" class="text-[9px] px-2 py-0.5 rounded font-black transition uppercase">EN</button>
                        <button type="button" onclick="traduzirNoDashboard('pt')" id="btn-dash-pt" class="text-[9px] px-2 py-0.5 rounded font-black transition uppercase">PT</button>
                    </div>
                </div>
            ...
            <form id="editForm" method="POST" class="space-y-6">
                ...
                <input type="hidden" name="first_release_date" id="inputRelease">
                ...
                <div class="grid grid-cols-2 gap-6">
                    <div>
                        ...
                        <select name="status" id="editStatus" class="w-full bg-[#0f111a] border-gray-700 rounded-xl text-white text-xs font-bold focus:ring-indigo-500 uppercase">
                ...
                <div>
                    ...
                    <textarea name="review" id="editReview" rows="4" class="w-full bg-[#0f111a] border-gray-700 rounded-2xl text-white text-xs focus:ring-indigo-500 resize-none custom-scrollbar p-4" placeholder="Escreva aqui o que achou, onde parou ou dicas do jogo..."></textarea>
                </div>

                <div class="flex gap-4 pt-2">
                    <button type="submit" id="btnSalvar" class="flex-1 bg-indigo-600 hover:bg-indigo-500 text-white font-black py-4 rounded-2xl transition uppercase tracking-widest shadow-lg italic">
                        Confirmar
                    </button>
                    <button type="button" id="btnDeleteTrigger" onclick="confirmarExclusao()" class="bg-red-600/10 hover:bg-red-600 text-red-500 hover:text-white px-6 py-4 rounded-2xl transition border border-red-600/20 hidden">
                        🗑️
                    </button>
                </div>
            </form>
